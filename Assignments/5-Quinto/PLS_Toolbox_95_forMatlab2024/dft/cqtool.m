function cqtool(msg)
%CQTOOL GUI tool for investigating the conditional QQ-plot.
%
%I/O: cqtool(x)
%
%See also: KTOOL, PLOTCQQ, PLOTKD, PLOTQQ, QTOOL
...
if strcmp(msg,'redraw')
	...
	overlay = ochr{oval} ;
	plotcqq(kstr.data,overlay,kstr.tra) ;
end
