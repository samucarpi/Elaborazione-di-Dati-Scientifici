function [g,g1,g2] = gupbound(x,a,d)
%GUPBOUND penalty function for upper boundd
...
%
%Example:
%     x = [0:0.0001:0.1]; a = 1; d = 0.09;
%     plot(x,gupbound(x,a,d)), vline(d), axis([0.088 0.092 0 0.25])
