function varargout = crossval_anndlda(varargin)
%CROSSVAL_ANNDLDA Helper function for ANNDLDA cross-validation.
...
out = crossval_anndl('getoptions',varargin{:});
...
[bbr,ssq] = crossval_anndl('precalcmodel',varargin{:});
...
[ypred,bbr] = crossval_anndl('apply',varargin{:});
