function varargout = crossval_annda(varargin)
%CROSSVAL_ANN Helper function for ANNDA cross-validation.
...
out = crossval_ann('getoptions',varargin{:});
...
[bbr,ssq] = crossval_ann('precalcmodel',varargin{:});
...
[ypred,bbr] = crossval_ann('apply',varargin{:});
