classdef EControl < hgsetget
%EControl - Generic (abstract) handle control for GUI controls.
%
% 
%
...
% written permission from Eigenvector Research, Inc.
  ...
  methods
    function obj = EControl(arg, varargin)
    ...
    function delete(obj)
      %Not sure if delete should be done here or in child control. Probably
      %in child control so comment out for now.
      %delete(obj.Control)
    end
