function varargout = knn_guifcn(varargin);
...
%create toolbar
[atb abtns] = toolbar(handles.analysis, 'knn','');
...
if strcmp(statmodl,'none')
  ...
  try
    ...
    modl      = knn(x,mink,opts);

  catch
    erdlgpls({'Error using KNN method',lasterr},'Calibrate Error');
    return
  end
...
%Returns options strucutre for knn 
