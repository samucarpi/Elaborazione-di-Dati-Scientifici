function varargout = crossval_lregda(varargin)
%CROSSVAL_LREG Helper function for LREGDA cross-validation.
...
out = crossval_lreg('getoptions',varargin{:});
...
[bbr,ssq] = crossval_lreg('precalcmodel',varargin{:});
...
[ypred,bbr] = crossval_lreg('apply',varargin{:});
