...
%ISOPTIMIZE Does args have any XGB parameter with length>1
% isOptimize checks the input options to see if they indicate a scan over
% XGB parameters to find an optimal set is desired. It determines this by
% checking if one of range-supporting xgb parameters' value has a range instead of a
% single value
%
