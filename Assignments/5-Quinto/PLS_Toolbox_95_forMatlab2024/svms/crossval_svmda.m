function varargout = crossval_svmda(varargin)
%CROSSVAL_SVM Helper function for SVMDA cross-validation.
...
out = crossval_svm('getoptions',varargin{:});
...
[bbr,ssq] = crossval_svm('precalcmodel',varargin{:});
...
[ypred,bbr] = crossval_svm('apply',varargin{:});
