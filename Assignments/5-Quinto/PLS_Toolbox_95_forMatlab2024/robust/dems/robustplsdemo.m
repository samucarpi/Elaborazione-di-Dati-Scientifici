echo on
% ROBUSTPLSDEMO Demo of the PLS function
...
%     algorithm: [ 'nip' | {'sim'} | 'robustpls' ]     PLS algorithm to use: NIPALS or SIMPLS
...
rmodel = pls(xblock1,yblock1,3,options)
 
% Please click a button on the menu to make plots...
makeplot(rmodel.detail.robustpls,'labsd',10,'labod',10)
...
valid = pls(xblock2,yblock2,rmodel);
...
%End of ROBUSTPLSDEMO
%See also ROBPCA, RPCR, MCDCOV, ...
