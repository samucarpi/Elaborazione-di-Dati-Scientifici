...
%      classic : If equal to one, the classical PCR analysis will be performed
...
%                      (orthogonal outliers) and/or whose residual distance is larger than result.cutoff.resd
...
%Computing flags
final.flag=((final.od<=final.cutoff.od)&(abs(final.resd)<=final.cutoff.resd));
