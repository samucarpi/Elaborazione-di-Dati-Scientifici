...
%                       and/or whose residual distance is larger than result.cutoff.resd
%                       receive a flag equal to zero. 
%                       All the other observations receive a flag 1. 
%   result.class      : 'CPCR'
...
out.flag=((out.cpca.od<=out.cutoff.od)&(abs(out.resd)<=out.cutoff.resd));
