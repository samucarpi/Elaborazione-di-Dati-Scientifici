...
% Reference: 
%  Rousseeuw, P.J. and Van Driessen, K. (2000), 
%  "An algorithm for positive-breakdown methods based on concentration steps",
%  in 'Data Analysis: Scientific Modeling and Practical Application',
%  edited by W. Gaul, O. Opitz and M. Schader, Springer-Verlag, New York, 335-346.  
%
...
%
% The output consists of two structures 'res' and 'raw' containing the 
% following fields:
%
...
% Last update: 06/07/2004,  03/07/2006 (profiler tips --> & -> &&, | --> ||)
...
if h == n 
    ...
    rew=struct('slope',{res.coefficients(1:p)},'int',{0},'fitted',{fitted},'res',{residuals},...
        ...
        'rd',{NaN},'cutoff',{cutoff},'flag',{NaN},'weights',{raw.wt},'Hsubsets',{res.Hsubsets},...
