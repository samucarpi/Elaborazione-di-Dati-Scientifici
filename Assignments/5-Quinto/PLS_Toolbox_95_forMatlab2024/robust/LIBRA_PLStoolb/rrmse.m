...
%  
%  Engelen, S., Hubert, M. (2004),
%  "Fast model selection for robust calibration methods",
%  Analytica Chimica Acta, to appear.
%
...
% Last Update on 28-04-2004,  03/07/2006
% Last Revision date 03-07-2006
...
if ktot ~=kmax
    disp(['Warning (rrmse.m): The maximal number of principal components is reduced to ',num2str(ktot)])
end
%%%%%%%%%%%%%%%% MAIN PART %%%%%%%%%%%%%%%%%%%%%%%%
if (k~=0) && nargin>7
